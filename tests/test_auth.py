...
AAD_SAML = (
    ...
    "&RelayState=https%3A%2F%2Fschool.example.edu%2Fd2l%2Fhome"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://School.Example.EDU/d2l/home", True, "hostname is case-insensitive"),
        ("https://school.example.edu:443/d2l/home", True, "explicit default port"),
        ("https://evil.example.com/d2l/home", False, "right path, wrong host"),
        (
            "https://school.example.edu.evil.com/d2l/home",
            False,
